...
open class BackupSecrets: BackupSecretsProtocol, @unchecked Sendable {
    ...
    public func uniffiCloneHandle() -> UInt64 {
        try! rustCall { uniffi_matrix_sdk_crypto_fn_clone_backupsecrets(self.handle, $0) }
    }
...
public struct FfiConverterTypeBackupSecrets: FfiConverter {
    ...
    public static func lift(_ handle: UInt64) throws -> BackupSecrets {
        BackupSecrets(unsafeFromHandle: handle)
    }
...
public func FfiConverterTypeBackupSecrets_lift(_ handle: UInt64) throws -> BackupSecrets {
    try FfiConverterTypeBackupSecrets.lift(handle)
}
...
public func FfiConverterTypeBackupSecrets_lower(_ value: BackupSecrets) -> UInt64 {
    FfiConverterTypeBackupSecrets.lower(value)
}
...
open class CrossSigningSecrets: CrossSigningSecretsProtocol, @unchecked Sendable {
    ...
    #endif
    public func uniffiCloneHandle() -> UInt64 {
        try! rustCall { uniffi_matrix_sdk_crypto_fn_clone_crosssigningsecrets(self.handle, $0) }
    }
...
public struct FfiConverterTypeCrossSigningSecrets: FfiConverter {
    ...
    public static func lift(_ handle: UInt64) throws -> CrossSigningSecrets {
        CrossSigningSecrets(unsafeFromHandle: handle)
    }
...
public func FfiConverterTypeCrossSigningSecrets_lift(_ handle: UInt64) throws -> CrossSigningSecrets {
    try FfiConverterTypeCrossSigningSecrets.lift(handle)
}
...
public func FfiConverterTypeCrossSigningSecrets_lower(_ value: CrossSigningSecrets) -> UInt64 {
    FfiConverterTypeCrossSigningSecrets.lower(value)
}
...
open class SecretsBundle: SecretsBundleProtocol, @unchecked Sendable {
    ...
    #endif
    public func uniffiCloneHandle() -> UInt64 {
        try! rustCall { uniffi_matrix_sdk_crypto_fn_clone_secretsbundle(self.handle, $0) }
    }
...
public struct FfiConverterTypeSecretsBundle: FfiConverter {
    ...
    public static func lift(_ handle: UInt64) throws -> SecretsBundle {
        SecretsBundle(unsafeFromHandle: handle)
    }
...
public func FfiConverterTypeSecretsBundle_lift(_ handle: UInt64) throws -> SecretsBundle {
    try FfiConverterTypeSecretsBundle.lift(handle)
}
...
public func FfiConverterTypeSecretsBundle_lower(_ value: SecretsBundle) -> UInt64 {
    FfiConverterTypeSecretsBundle.lower(value)
}
...
public struct FfiConverterTypeDecryptionSettings: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> DecryptionSettings {
        try DecryptionSettings(senderDeviceTrustRequirement: FfiConverterTypeTrustRequirement.read(from: &buf))
    }
...
public func FfiConverterTypeDecryptionSettings_lift(_ buf: RustBuffer) throws -> DecryptionSettings {
    try FfiConverterTypeDecryptionSettings.lift(buf)
}
...
public func FfiConverterTypeDecryptionSettings_lower(_ value: DecryptionSettings) -> RustBuffer {
    FfiConverterTypeDecryptionSettings.lower(value)
}
...
public func FfiConverterTypeCollectStrategy_lift(_ buf: RustBuffer) throws -> CollectStrategy {
    try FfiConverterTypeCollectStrategy.lift(buf)
}
...
public func FfiConverterTypeCollectStrategy_lower(_ value: CollectStrategy) -> RustBuffer {
    FfiConverterTypeCollectStrategy.lower(value)
}
...
public func FfiConverterTypeIdentityState_lift(_ buf: RustBuffer) throws -> IdentityState {
    try FfiConverterTypeIdentityState.lift(buf)
}
...
public func FfiConverterTypeIdentityState_lower(_ value: IdentityState) -> RustBuffer {
    FfiConverterTypeIdentityState.lower(value)
}
...
public func FfiConverterTypeLocalTrust_lift(_ buf: RustBuffer) throws -> LocalTrust {
    try FfiConverterTypeLocalTrust.lift(buf)
}
...
public func FfiConverterTypeLocalTrust_lower(_ value: LocalTrust) -> RustBuffer {
    FfiConverterTypeLocalTrust.lower(value)
}
...
public struct FfiConverterTypeLoginQrCodeDecodeError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> LoginQrCodeDecodeError {
        let variant: Int32 = try readInt(&buf)
        switch variant {
        case 1: return try .NotEnoughData(message: FfiConverterString.read(from: &buf))
            
        case 2: return try .NotUtf8(message: FfiConverterString.read(from: &buf))
            
        case 3: return try .UrlParse(message: FfiConverterString.read(from: &buf))
            
        case 4: return try .InvalidIntent(message: FfiConverterString.read(from: &buf))
            
        case 5: return try .InvalidType(message: FfiConverterString.read(from: &buf))
            
        case 6: return try .Base64(message: FfiConverterString.read(from: &buf))
            
        case 7: return try .InvalidPrefix(message: FfiConverterString.read(from: &buf))
...
public func FfiConverterTypeLoginQrCodeDecodeError_lift(_ buf: RustBuffer) throws -> LoginQrCodeDecodeError {
    try FfiConverterTypeLoginQrCodeDecodeError.lift(buf)
}
...
public func FfiConverterTypeLoginQrCodeDecodeError_lower(_ value: LoginQrCodeDecodeError) -> RustBuffer {
    FfiConverterTypeLoginQrCodeDecodeError.lower(value)
}
...
public func FfiConverterTypeQrCodeIntent_lift(_ buf: RustBuffer) throws -> QrCodeIntent {
    try FfiConverterTypeQrCodeIntent.lift(buf)
}
...
public func FfiConverterTypeQrCodeIntent_lower(_ value: QrCodeIntent) -> RustBuffer {
    FfiConverterTypeQrCodeIntent.lower(value)
}
...
public func FfiConverterTypeSignatureState_lift(_ buf: RustBuffer) throws -> SignatureState {
    try FfiConverterTypeSignatureState.lift(buf)
}
...
public func FfiConverterTypeSignatureState_lower(_ value: SignatureState) -> RustBuffer {
    FfiConverterTypeSignatureState.lower(value)
}
...
public func FfiConverterTypeTrustRequirement_lift(_ buf: RustBuffer) throws -> TrustRequirement {
    try FfiConverterTypeTrustRequirement.lift(buf)
}
...
public func FfiConverterTypeTrustRequirement_lower(_ value: TrustRequirement) -> RustBuffer {
    FfiConverterTypeTrustRequirement.lower(value)
}
...
public func FfiConverterTypeUtdCause_lift(_ buf: RustBuffer) throws -> UtdCause {
    try FfiConverterTypeUtdCause.lift(buf)
}
...
public func FfiConverterTypeUtdCause_lower(_ value: UtdCause) -> RustBuffer {
    FfiConverterTypeUtdCause.lower(value)
}

...
private extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_matrix_sdk_contentscanner_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }
    
    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_matrix_sdk_contentscanner_rustbuffer_free(self, $0) }
    }
}
...
public struct FfiConverterTypeMediaScanResponse: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> MediaScanResponse {
        try MediaScanResponse(clean: FfiConverterBool.read(from: &buf),
...
public func FfiConverterTypeMediaScanResponse_lift(_ buf: RustBuffer) throws -> MediaScanResponse {
    try FfiConverterTypeMediaScanResponse.lift(buf)
}
...
public func FfiConverterTypeMediaScanResponse_lower(_ value: MediaScanResponse) -> RustBuffer {
    FfiConverterTypeMediaScanResponse.lower(value)
}
...
public enum ErrorReason: Equatable, Hashable {
    /**
     * The JSON file is malformed.
     */
    case mcsMalformedJson
    /**
     * The media could not be decrypted.
     */
    case mcsMediaFailedToDecrypt
    /**
     ...
     */
    case mcsMediaRequestFailed
}

#if compiler(>=6)
extension ErrorReason: Sendable { }
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeErrorReason: FfiConverterRustBuffer {
    typealias SwiftType = ErrorReason
    
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ErrorReason {
        let variant: Int32 = try readInt(&buf)
        switch variant {
        case 1: return .mcsMalformedJson
            
        case 2: return .mcsMediaFailedToDecrypt
            
        case 3: return .mMissingToken
            
        case 4: return .mUnknownToken
            
        case 5: return .mNotFound
            
        case 6: return .mcsMediaNotClean
            
        case 7: return .mcsMimeTypeForbidden
            
        case 8: return .mcsBadDecryption
            
        case 9: return .mUnknown
            
        case 10: return .mcsMediaRequestFailed
            
        default: throw UniffiInternalError.unexpectedEnumCase
        }
    }
    
    public static func write(_ value: ErrorReason, into buf: inout [UInt8]) {
        switch value {
        case .mcsMalformedJson:
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeErrorReason_lift(_ buf: RustBuffer) throws -> ErrorReason {
    try FfiConverterTypeErrorReason.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeErrorReason_lower(_ value: ErrorReason) -> RustBuffer {
    FfiConverterTypeErrorReason.lower(value)
}
...
private let initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_matrix_sdk_contentscanner_uniffi_contract_version()
...
public func uniffiEnsureMatrixSdkContentscannerInitialized() {

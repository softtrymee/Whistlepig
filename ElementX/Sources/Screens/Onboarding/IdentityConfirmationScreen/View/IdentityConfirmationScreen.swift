...
struct IdentityConfirmationScreen: View {
    private func primaryActionLabel(_ title: String) -> some View {
        Text(title)
            ...
            .padding(.vertical, 14)
            .background {
                Capsule().fill(WhistlepigBrand.marmotBrown)
            }
    }
            ...
            if let availableActions = context.viewState.availableActions {
                if availableActions.contains(.interactiveVerification) {
                    Button {
                        ...
                        primaryActionLabel(L10n.screenIdentityConfirmationUseAnotherDevice)
                    }
                    .buttonStyle(.plain)
                }
                ...
                if availableActions.contains(.recovery) {
                    Button {
                        ...
                        primaryActionLabel(L10n.screenIdentityConfirmationUseRecoveryKey)
                    }
                    .buttonStyle(.plain)
                }

...
enum HomeScreenViewAction {
    ...
    case setRoomHidden(roomIdentifier: String, isHidden: Bool)
...
struct HomeScreenViewState: BindableState {
    ...
    var visibleRooms: [HomeScreenRoom] {
        ...
        return rooms.filter { room in
            bindings.filtersState.isShowingHiddenRooms ? bindings.hiddenRoomIDs.contains(room.id) : !bindings.hiddenRoomIDs.contains(room.id)
        }
    }

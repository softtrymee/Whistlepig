...
class TimelineInteractionHandler {
    ...
    func handleTimelineItemMenuAction(_ action: TimelineItemMenuAction, itemID: TimelineItemIdentifier) {
        ...
        case .selectText:
            // Selection is transient view state and is handled by TimelineViewModel before this
            // handler is called. Keep this case for callers such as the Mac context menu.
            return

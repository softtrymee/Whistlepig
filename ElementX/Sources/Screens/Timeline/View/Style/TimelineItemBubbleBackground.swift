...
private struct TimelineItemBubbleBackgroundModifier: ViewModifier {
    ...
    private var backgroundShape: RoundedCornerShape {
        RoundedCornerShape(radius: WhistlepigTheme.Radius.message,
                           corners: .allCorners,
                           compactRadius: 7,
                           compactCorners: .allCorners.subtracting(roundedCorners))
    }

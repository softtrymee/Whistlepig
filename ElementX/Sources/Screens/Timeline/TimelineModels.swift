...
struct TimelineViewStateBindings {
    ...
    var stickerPickerViewModel: StickerPickerViewModel?
    
    var showTranslation = false
    var textToBeTranslated: String?

    /// The one timeline item whose text is currently allowed to use native UITextView selection.
    /// This is deliberately transient UI state rather than part of the interaction handler.
    var textSelectionItemID: TimelineItemIdentifier?
}

...
class TimelineMediaPreviewViewModel: TimelineMediaPreviewViewModelType {
    ...
    /// The caption renderer uses the same room context as the timeline so links, mentions and
    /// pills have the dependencies they normally receive from TimelineView.
    var timelineContext: TimelineViewModel.Context {
        timelineViewModel.context
    }

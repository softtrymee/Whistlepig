...
enum TestablePreviewsDictionary {
    static let dictionary: [String: any PreviewProvider.Type] = {
        var dictionary: [String: any PreviewProvider.Type] = [
            ...
            "ContentScanningFailureView_Previews" : ContentScanningFailureView_Previews.self,
            ...
            "SwipeLeftAction_Previews" : SwipeLeftAction_Previews.self,
        ...
        if #available(iOS 26.0, *) {
            ...
            dictionary["LinkNewDeviceScreen_Previews"] = LinkNewDeviceScreen_Previews.self
            dictionary["LoginScreen_Previews"] = LoginScreen_Previews.self
            dictionary["NotificationSettingsScreen_Previews"] = NotificationSettingsScreen_Previews.self
            dictionary["RoomDetailsScreen_Previews"] = RoomDetailsScreen_Previews.self
            dictionary["SecureBackupLogoutConfirmationScreen_Previews"] = SecureBackupLogoutConfirmationScreen_Previews.self
            dictionary["SecureBackupRecoveryKeyScreen_Previews"] = SecureBackupRecoveryKeyScreen_Previews.self
            dictionary["SecureBackupScreen_Previews"] = SecureBackupScreen_Previews.self
            dictionary["ServerSelection_Previews"] = ServerSelection_Previews.self
            dictionary["SettingsScreen_Previews"] = SettingsScreen_Previews.self
            dictionary["SpaceAddRoomsScreen_Previews"] = SpaceAddRoomsScreen_Previews.self
            dictionary["SpaceScreen_Previews"] = SpaceScreen_Previews.self
            dictionary["TimelineMediaPreviewDetailsView_Previews"] = TimelineMediaPreviewDetailsView_Previews.self
            dictionary["UserProfileScreen_Previews"] = UserProfileScreen_Previews.self
        }
        return dictionary
    }()
 }

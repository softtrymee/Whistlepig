...
struct VisualListItem_Previews: PreviewProvider, TestablePreview {
    static let strings = ["Private by default", "No data leaves this device", "You can review your settings"]
    ...
    static var previews: some View {
        VStack(alignment: .leading, spacing: 4) {
            VisualListItem(title: strings[0], position: .top) {
                testImage1
            }
            VisualListItem(title: strings[1], position: .middle) {
                testImage2
            }

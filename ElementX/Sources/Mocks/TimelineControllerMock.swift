...
@MainActor extension TimelineControllerMock {
    ...
    convenience init(_ configuration: TimelineControllerMockConfiguration) {
        ...
        sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleClosure = { [weak self, timelineProxy] url, audioInfo, caption, intentionalMentions, requestHandle in
        ...
        sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleClosure = { [weak self, timelineProxy] url, fileInfo, caption, intentionalMentions, requestHandle in
            self?.callbacks.send(.messageSentOrEdited)
            if let timelineProxy {
        ...
        sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleClosure = { [weak self, timelineProxy] url, thumbnailURL, imageInfo, caption, intentionalMentions, requestHandle in
            self?.callbacks.send(.messageSentOrEdited)
            if let timelineProxy {
        ...
        sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleClosure = { [weak self, timelineProxy] url, thumbnailURL, videoInfo, caption, intentionalMentions, requestHandle in
            self?.callbacks.send(.messageSentOrEdited)
            if let timelineProxy {
        ...
        sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDClosure = { [weak self, timelineProxy] itemInfos, caption, intentionalMentions, inReplyToEventID in
            self?.callbacks.send(.messageSentOrEdited)
            if let timelineProxy {

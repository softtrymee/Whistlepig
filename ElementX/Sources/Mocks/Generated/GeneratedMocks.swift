...
nonisolated class ClientProxyMock: ClientProxyProtocol, @unchecked Sendable {
    ...
    private let accountDataEventTypeCallsCountLock = NSLock()
    private nonisolated(unsafe) var accountDataEventTypeUnderlyingCallsCount = 0
    var accountDataEventTypeCallsCount: Int {
        get { accountDataEventTypeCallsCountLock.withLock { accountDataEventTypeUnderlyingCallsCount } }
        set { accountDataEventTypeCallsCountLock.withLock { accountDataEventTypeUnderlyingCallsCount = newValue } }
    }
    var accountDataEventTypeCalled: Bool {
        return accountDataEventTypeCallsCount > 0
    }
    private let accountDataEventTypeReceivedEventTypeLock = NSLock()
    private nonisolated(unsafe) var accountDataEventTypeUnderlyingReceivedEventType: String?
    var accountDataEventTypeReceivedEventType: String? {
        get { accountDataEventTypeReceivedEventTypeLock.withLock { accountDataEventTypeUnderlyingReceivedEventType } }
        set { accountDataEventTypeReceivedEventTypeLock.withLock { accountDataEventTypeUnderlyingReceivedEventType = newValue } }
    }
    private let accountDataEventTypeReceivedInvocationsLock = NSLock()
    private nonisolated(unsafe) var accountDataEventTypeUnderlyingReceivedInvocations: [String] = []
    var accountDataEventTypeReceivedInvocations: [String] {
        get { accountDataEventTypeReceivedInvocationsLock.withLock { accountDataEventTypeUnderlyingReceivedInvocations } }
        set { accountDataEventTypeReceivedInvocationsLock.withLock { accountDataEventTypeUnderlyingReceivedInvocations = newValue } }
    }

    private let accountDataEventTypeReturnValueLock = NSLock()
    private nonisolated(unsafe) var accountDataEventTypeUnderlyingReturnValue: Result<String?, ClientProxyError>!
    var accountDataEventTypeReturnValue: Result<String?, ClientProxyError>! {
        get { accountDataEventTypeReturnValueLock.withLock { accountDataEventTypeUnderlyingReturnValue } }
        set { accountDataEventTypeReturnValueLock.withLock { accountDataEventTypeUnderlyingReturnValue = newValue } }
    }
    nonisolated(unsafe) var accountDataEventTypeClosure: ((String) async -> Result<String?, ClientProxyError>)?

    @concurrent func accountData(eventType: String) async -> Result<String?, ClientProxyError> {
        accountDataEventTypeCallsCountLock.withLock { accountDataEventTypeUnderlyingCallsCount += 1 }
        accountDataEventTypeReceivedEventType = eventType
        accountDataEventTypeReceivedInvocationsLock.withLock { accountDataEventTypeUnderlyingReceivedInvocations.append(eventType) }
        if let accountDataEventTypeClosure = accountDataEventTypeClosure {
            return await accountDataEventTypeClosure(eventType)
        } else {
            return accountDataEventTypeReturnValue
        }
    }
    //MARK: - fetchAccountData

    private let fetchAccountDataEventTypeCallsCountLock = NSLock()
    private nonisolated(unsafe) var fetchAccountDataEventTypeUnderlyingCallsCount = 0
    var fetchAccountDataEventTypeCallsCount: Int {
        get { fetchAccountDataEventTypeCallsCountLock.withLock { fetchAccountDataEventTypeUnderlyingCallsCount } }
        set { fetchAccountDataEventTypeCallsCountLock.withLock { fetchAccountDataEventTypeUnderlyingCallsCount = newValue } }
    }
    var fetchAccountDataEventTypeCalled: Bool {
        return fetchAccountDataEventTypeCallsCount > 0
    }
    private let fetchAccountDataEventTypeReceivedEventTypeLock = NSLock()
    private nonisolated(unsafe) var fetchAccountDataEventTypeUnderlyingReceivedEventType: String?
    var fetchAccountDataEventTypeReceivedEventType: String? {
        get { fetchAccountDataEventTypeReceivedEventTypeLock.withLock { fetchAccountDataEventTypeUnderlyingReceivedEventType } }
        set { fetchAccountDataEventTypeReceivedEventTypeLock.withLock { fetchAccountDataEventTypeUnderlyingReceivedEventType = newValue } }
    }
    private let fetchAccountDataEventTypeReceivedInvocationsLock = NSLock()
    private nonisolated(unsafe) var fetchAccountDataEventTypeUnderlyingReceivedInvocations: [String] = []
    var fetchAccountDataEventTypeReceivedInvocations: [String] {
        get { fetchAccountDataEventTypeReceivedInvocationsLock.withLock { fetchAccountDataEventTypeUnderlyingReceivedInvocations } }
        set { fetchAccountDataEventTypeReceivedInvocationsLock.withLock { fetchAccountDataEventTypeUnderlyingReceivedInvocations = newValue } }
    }

    private let fetchAccountDataEventTypeReturnValueLock = NSLock()
    private nonisolated(unsafe) var fetchAccountDataEventTypeUnderlyingReturnValue: Result<String?, ClientProxyError>!
    var fetchAccountDataEventTypeReturnValue: Result<String?, ClientProxyError>! {
        get { fetchAccountDataEventTypeReturnValueLock.withLock { fetchAccountDataEventTypeUnderlyingReturnValue } }
        set { fetchAccountDataEventTypeReturnValueLock.withLock { fetchAccountDataEventTypeUnderlyingReturnValue = newValue } }
    }
    nonisolated(unsafe) var fetchAccountDataEventTypeClosure: ((String) async -> Result<String?, ClientProxyError>)?

    @concurrent func fetchAccountData(eventType: String) async -> Result<String?, ClientProxyError> {
        fetchAccountDataEventTypeCallsCountLock.withLock { fetchAccountDataEventTypeUnderlyingCallsCount += 1 }
        fetchAccountDataEventTypeReceivedEventType = eventType
        fetchAccountDataEventTypeReceivedInvocationsLock.withLock { fetchAccountDataEventTypeUnderlyingReceivedInvocations.append(eventType) }
        if let fetchAccountDataEventTypeClosure = fetchAccountDataEventTypeClosure {
            return await fetchAccountDataEventTypeClosure(eventType)
        } else {
            return fetchAccountDataEventTypeReturnValue
        }
    }
    //MARK: - fetchStateEventsRaw

    private let fetchStateEventsRawRoomIDCallsCountLock = NSLock()
    private nonisolated(unsafe) var fetchStateEventsRawRoomIDUnderlyingCallsCount = 0
    var fetchStateEventsRawRoomIDCallsCount: Int {
        get { fetchStateEventsRawRoomIDCallsCountLock.withLock { fetchStateEventsRawRoomIDUnderlyingCallsCount } }
        set { fetchStateEventsRawRoomIDCallsCountLock.withLock { fetchStateEventsRawRoomIDUnderlyingCallsCount = newValue } }
    }
    var fetchStateEventsRawRoomIDCalled: Bool {
        return fetchStateEventsRawRoomIDCallsCount > 0
    }
    private let fetchStateEventsRawRoomIDReceivedRoomIDLock = NSLock()
    private nonisolated(unsafe) var fetchStateEventsRawRoomIDUnderlyingReceivedRoomID: String?
    var fetchStateEventsRawRoomIDReceivedRoomID: String? {
        get { fetchStateEventsRawRoomIDReceivedRoomIDLock.withLock { fetchStateEventsRawRoomIDUnderlyingReceivedRoomID } }
        set { fetchStateEventsRawRoomIDReceivedRoomIDLock.withLock { fetchStateEventsRawRoomIDUnderlyingReceivedRoomID = newValue } }
    }
    private let fetchStateEventsRawRoomIDReceivedInvocationsLock = NSLock()
    private nonisolated(unsafe) var fetchStateEventsRawRoomIDUnderlyingReceivedInvocations: [String] = []
    var fetchStateEventsRawRoomIDReceivedInvocations: [String] {
        get { fetchStateEventsRawRoomIDReceivedInvocationsLock.withLock { fetchStateEventsRawRoomIDUnderlyingReceivedInvocations } }
        set { fetchStateEventsRawRoomIDReceivedInvocationsLock.withLock { fetchStateEventsRawRoomIDUnderlyingReceivedInvocations = newValue } }
    }

    private let fetchStateEventsRawRoomIDReturnValueLock = NSLock()
    private nonisolated(unsafe) var fetchStateEventsRawRoomIDUnderlyingReturnValue: Result<[String], ClientProxyError>!
    var fetchStateEventsRawRoomIDReturnValue: Result<[String], ClientProxyError>! {
        get { fetchStateEventsRawRoomIDReturnValueLock.withLock { fetchStateEventsRawRoomIDUnderlyingReturnValue } }
        set { fetchStateEventsRawRoomIDReturnValueLock.withLock { fetchStateEventsRawRoomIDUnderlyingReturnValue = newValue } }
    }
    nonisolated(unsafe) var fetchStateEventsRawRoomIDClosure: ((String) async -> Result<[String], ClientProxyError>)?

    @concurrent func fetchStateEventsRaw(roomID: String) async -> Result<[String], ClientProxyError> {
        fetchStateEventsRawRoomIDCallsCountLock.withLock { fetchStateEventsRawRoomIDUnderlyingCallsCount += 1 }
        fetchStateEventsRawRoomIDReceivedRoomID = roomID
        fetchStateEventsRawRoomIDReceivedInvocationsLock.withLock { fetchStateEventsRawRoomIDUnderlyingReceivedInvocations.append(roomID) }
        if let fetchStateEventsRawRoomIDClosure = fetchStateEventsRawRoomIDClosure {
            return await fetchStateEventsRawRoomIDClosure(roomID)
        } else {
            return fetchStateEventsRawRoomIDReturnValue
        }
    }
...
nonisolated class JoinedRoomProxyMock: JoinedRoomProxyProtocol, @unchecked Sendable {
    ...
    private let stateEventsRawEventTypeCallsCountLock = NSLock()
    private nonisolated(unsafe) var stateEventsRawEventTypeUnderlyingCallsCount = 0
    var stateEventsRawEventTypeCallsCount: Int {
        get { stateEventsRawEventTypeCallsCountLock.withLock { stateEventsRawEventTypeUnderlyingCallsCount } }
        set { stateEventsRawEventTypeCallsCountLock.withLock { stateEventsRawEventTypeUnderlyingCallsCount = newValue } }
    }
    var stateEventsRawEventTypeCalled: Bool {
        return stateEventsRawEventTypeCallsCount > 0
    }
    private let stateEventsRawEventTypeReceivedEventTypeLock = NSLock()
    private nonisolated(unsafe) var stateEventsRawEventTypeUnderlyingReceivedEventType: String?
    var stateEventsRawEventTypeReceivedEventType: String? {
        get { stateEventsRawEventTypeReceivedEventTypeLock.withLock { stateEventsRawEventTypeUnderlyingReceivedEventType } }
        set { stateEventsRawEventTypeReceivedEventTypeLock.withLock { stateEventsRawEventTypeUnderlyingReceivedEventType = newValue } }
    }
    private let stateEventsRawEventTypeReceivedInvocationsLock = NSLock()
    private nonisolated(unsafe) var stateEventsRawEventTypeUnderlyingReceivedInvocations: [String] = []
    var stateEventsRawEventTypeReceivedInvocations: [String] {
        get { stateEventsRawEventTypeReceivedInvocationsLock.withLock { stateEventsRawEventTypeUnderlyingReceivedInvocations } }
        set { stateEventsRawEventTypeReceivedInvocationsLock.withLock { stateEventsRawEventTypeUnderlyingReceivedInvocations = newValue } }
    }

    private let stateEventsRawEventTypeReturnValueLock = NSLock()
    private nonisolated(unsafe) var stateEventsRawEventTypeUnderlyingReturnValue: Result<[String], RoomProxyError>!
    var stateEventsRawEventTypeReturnValue: Result<[String], RoomProxyError>! {
        get { stateEventsRawEventTypeReturnValueLock.withLock { stateEventsRawEventTypeUnderlyingReturnValue } }
        set { stateEventsRawEventTypeReturnValueLock.withLock { stateEventsRawEventTypeUnderlyingReturnValue = newValue } }
    }
    nonisolated(unsafe) var stateEventsRawEventTypeClosure: ((String) async -> Result<[String], RoomProxyError>)?

    @concurrent func stateEventsRaw(eventType: String) async -> Result<[String], RoomProxyError> {
        stateEventsRawEventTypeCallsCountLock.withLock { stateEventsRawEventTypeUnderlyingCallsCount += 1 }
        stateEventsRawEventTypeReceivedEventType = eventType
        stateEventsRawEventTypeReceivedInvocationsLock.withLock { stateEventsRawEventTypeUnderlyingReceivedInvocations.append(eventType) }
        if let stateEventsRawEventTypeClosure = stateEventsRawEventTypeClosure {
            return await stateEventsRawEventTypeClosure(eventType)
        } else {
            return stateEventsRawEventTypeReturnValue
        }
    }
    //MARK: - sendSticker

    private let sendStickerContentCallsCountLock = NSLock()
    private nonisolated(unsafe) var sendStickerContentUnderlyingCallsCount = 0
    var sendStickerContentCallsCount: Int {
        get { sendStickerContentCallsCountLock.withLock { sendStickerContentUnderlyingCallsCount } }
        set { sendStickerContentCallsCountLock.withLock { sendStickerContentUnderlyingCallsCount = newValue } }
    }
    var sendStickerContentCalled: Bool {
        return sendStickerContentCallsCount > 0
    }
    private let sendStickerContentReceivedContentLock = NSLock()
    private nonisolated(unsafe) var sendStickerContentUnderlyingReceivedContent: String?
    var sendStickerContentReceivedContent: String? {
        get { sendStickerContentReceivedContentLock.withLock { sendStickerContentUnderlyingReceivedContent } }
        set { sendStickerContentReceivedContentLock.withLock { sendStickerContentUnderlyingReceivedContent = newValue } }
    }
    private let sendStickerContentReceivedInvocationsLock = NSLock()
    private nonisolated(unsafe) var sendStickerContentUnderlyingReceivedInvocations: [String] = []
    var sendStickerContentReceivedInvocations: [String] {
        get { sendStickerContentReceivedInvocationsLock.withLock { sendStickerContentUnderlyingReceivedInvocations } }
        set { sendStickerContentReceivedInvocationsLock.withLock { sendStickerContentUnderlyingReceivedInvocations = newValue } }
    }

    private let sendStickerContentReturnValueLock = NSLock()
    private nonisolated(unsafe) var sendStickerContentUnderlyingReturnValue: Result<Void, RoomProxyError>!
    var sendStickerContentReturnValue: Result<Void, RoomProxyError>! {
        get { sendStickerContentReturnValueLock.withLock { sendStickerContentUnderlyingReturnValue } }
        set { sendStickerContentReturnValueLock.withLock { sendStickerContentUnderlyingReturnValue = newValue } }
    }
    nonisolated(unsafe) var sendStickerContentClosure: ((String) async -> Result<Void, RoomProxyError>)?

    @concurrent func sendSticker(content: String) async -> Result<Void, RoomProxyError> {
        sendStickerContentCallsCountLock.withLock { sendStickerContentUnderlyingCallsCount += 1 }
        sendStickerContentReceivedContent = content
        sendStickerContentReceivedInvocationsLock.withLock { sendStickerContentUnderlyingReceivedInvocations.append(content) }
        if let sendStickerContentClosure = sendStickerContentClosure {
            return await sendStickerContentClosure(content)
        } else {
            return sendStickerContentReturnValue
        }
    }
...
nonisolated class TimelineControllerMock: TimelineControllerProtocol, @unchecked Sendable {
    ...
    private let sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleCallsCountLock = NSLock()
    private nonisolated(unsafe) var sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleUnderlyingCallsCount = 0
    var sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleCallsCount: Int {
        get { sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleCallsCountLock.withLock { sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleUnderlyingCallsCount } }
        set { sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleCallsCountLock.withLock { sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleUnderlyingCallsCount = newValue } }
    }
    var sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleCalled: Bool {
        return sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleCallsCount > 0
    }

    private let sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleReturnValueLock = NSLock()
    private nonisolated(unsafe) var sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleUnderlyingReturnValue: Result<Void, TimelineControllerError>!
    var sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleReturnValue: Result<Void, TimelineControllerError>! {
        get { sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleReturnValueLock.withLock { sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleUnderlyingReturnValue } }
        set { sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleReturnValueLock.withLock { sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleUnderlyingReturnValue = newValue } }
    }
    nonisolated(unsafe) var sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleClosure: ((URL, AudioInfo, String?, IntentionalMentions, @MainActor (SendAttachmentJoinHandleProtocol) -> Void) async -> Result<Void, TimelineControllerError>)?

    @concurrent func sendAudio(url: URL, audioInfo: AudioInfo, caption: String?, intentionalMentions: IntentionalMentions, requestHandle: @MainActor (SendAttachmentJoinHandleProtocol) -> Void) async -> Result<Void, TimelineControllerError> {
        sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleCallsCountLock.withLock { sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleUnderlyingCallsCount += 1 }
        if let sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleClosure = sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleClosure {
            return await sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleClosure(url, audioInfo, caption, intentionalMentions, requestHandle)
        } else {
            return sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleReturnValue
        }
    }
    //MARK: - sendFile

    private let sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleCallsCountLock = NSLock()
    private nonisolated(unsafe) var sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleUnderlyingCallsCount = 0
    var sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleCallsCount: Int {
        get { sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleCallsCountLock.withLock { sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleUnderlyingCallsCount } }
        set { sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleCallsCountLock.withLock { sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleUnderlyingCallsCount = newValue } }
    }
    var sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleCalled: Bool {
        return sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleCallsCount > 0
    }

    private let sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleReturnValueLock = NSLock()
    private nonisolated(unsafe) var sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleUnderlyingReturnValue: Result<Void, TimelineControllerError>!
    var sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleReturnValue: Result<Void, TimelineControllerError>! {
        get { sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleReturnValueLock.withLock { sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleUnderlyingReturnValue } }
        set { sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleReturnValueLock.withLock { sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleUnderlyingReturnValue = newValue } }
    }
    nonisolated(unsafe) var sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleClosure: ((URL, FileInfo, String?, IntentionalMentions, @MainActor (SendAttachmentJoinHandleProtocol) -> Void) async -> Result<Void, TimelineControllerError>)?

    @concurrent func sendFile(url: URL, fileInfo: FileInfo, caption: String?, intentionalMentions: IntentionalMentions, requestHandle: @MainActor (SendAttachmentJoinHandleProtocol) -> Void) async -> Result<Void, TimelineControllerError> {
        sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleCallsCountLock.withLock { sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleUnderlyingCallsCount += 1 }
        if let sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleClosure = sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleClosure {
            return await sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleClosure(url, fileInfo, caption, intentionalMentions, requestHandle)
        } else {
            return sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleReturnValue
        }
    }
    //MARK: - sendImage

    private let sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleCallsCountLock = NSLock()
    private nonisolated(unsafe) var sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleUnderlyingCallsCount = 0
    var sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleCallsCount: Int {
        get { sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleCallsCountLock.withLock { sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleUnderlyingCallsCount } }
        set { sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleCallsCountLock.withLock { sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleUnderlyingCallsCount = newValue } }
    }
    var sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleCalled: Bool {
        return sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleCallsCount > 0
    }

    private let sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleReturnValueLock = NSLock()
    private nonisolated(unsafe) var sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleUnderlyingReturnValue: Result<Void, TimelineControllerError>!
    var sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleReturnValue: Result<Void, TimelineControllerError>! {
        get { sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleReturnValueLock.withLock { sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleUnderlyingReturnValue } }
        set { sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleReturnValueLock.withLock { sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleUnderlyingReturnValue = newValue } }
    }
    nonisolated(unsafe) var sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleClosure: ((URL, URL, ImageInfo, String?, IntentionalMentions, @MainActor (SendAttachmentJoinHandleProtocol) -> Void) async -> Result<Void, TimelineControllerError>)?

    @concurrent func sendImage(url: URL, thumbnailURL: URL, imageInfo: ImageInfo, caption: String?, intentionalMentions: IntentionalMentions, requestHandle: @MainActor (SendAttachmentJoinHandleProtocol) -> Void) async -> Result<Void, TimelineControllerError> {
        sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleCallsCountLock.withLock { sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleUnderlyingCallsCount += 1 }
        if let sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleClosure = sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleClosure {
            return await sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleClosure(url, thumbnailURL, imageInfo, caption, intentionalMentions, requestHandle)
        } else {
            return sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleReturnValue
        }
    }
    //MARK: - sendVideo

    private let sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleCallsCountLock = NSLock()
    private nonisolated(unsafe) var sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleUnderlyingCallsCount = 0
    var sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleCallsCount: Int {
        get { sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleCallsCountLock.withLock { sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleUnderlyingCallsCount } }
        set { sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleCallsCountLock.withLock { sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleUnderlyingCallsCount = newValue } }
    }
    var sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleCalled: Bool {
        return sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleCallsCount > 0
    }

    private let sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleReturnValueLock = NSLock()
    private nonisolated(unsafe) var sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleUnderlyingReturnValue: Result<Void, TimelineControllerError>!
    var sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleReturnValue: Result<Void, TimelineControllerError>! {
        get { sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleReturnValueLock.withLock { sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleUnderlyingReturnValue } }
        set { sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleReturnValueLock.withLock { sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleUnderlyingReturnValue = newValue } }
    }
    nonisolated(unsafe) var sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleClosure: ((URL, URL, VideoInfo, String?, IntentionalMentions, @MainActor (SendAttachmentJoinHandleProtocol) -> Void) async -> Result<Void, TimelineControllerError>)?

    @concurrent func sendVideo(url: URL, thumbnailURL: URL, videoInfo: VideoInfo, caption: String?, intentionalMentions: IntentionalMentions, requestHandle: @MainActor (SendAttachmentJoinHandleProtocol) -> Void) async -> Result<Void, TimelineControllerError> {
        sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleCallsCountLock.withLock { sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleUnderlyingCallsCount += 1 }
        if let sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleClosure = sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleClosure {
            return await sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleClosure(url, thumbnailURL, videoInfo, caption, intentionalMentions, requestHandle)
        } else {
            return sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleReturnValue
        }
    }
    ...
    private let sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDCallsCountLock = NSLock()
    private nonisolated(unsafe) var sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDUnderlyingCallsCount = 0
    var sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDCallsCount: Int {
        get { sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDCallsCountLock.withLock { sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDUnderlyingCallsCount } }
        set { sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDCallsCountLock.withLock { sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDUnderlyingCallsCount = newValue } }
    }
    var sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDCalled: Bool {
        return sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDCallsCount > 0
    }
    private let sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDReceivedArgumentsLock = NSLock()
    private nonisolated(unsafe) var sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDUnderlyingReceivedArguments: (itemInfos: [GalleryItemInfo], caption: String?, intentionalMentions: IntentionalMentions, inReplyToEventID: String?)?
    var sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDReceivedArguments: (itemInfos: [GalleryItemInfo], caption: String?, intentionalMentions: IntentionalMentions, inReplyToEventID: String?)? {
        get { sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDReceivedArgumentsLock.withLock { sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDUnderlyingReceivedArguments } }
        set { sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDReceivedArgumentsLock.withLock { sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDUnderlyingReceivedArguments = newValue } }
    }
    private let sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDReceivedInvocationsLock = NSLock()
    private nonisolated(unsafe) var sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDUnderlyingReceivedInvocations: [(itemInfos: [GalleryItemInfo], caption: String?, intentionalMentions: IntentionalMentions, inReplyToEventID: String?)] = []
    var sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDReceivedInvocations: [(itemInfos: [GalleryItemInfo], caption: String?, intentionalMentions: IntentionalMentions, inReplyToEventID: String?)] {
        get { sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDReceivedInvocationsLock.withLock { sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDUnderlyingReceivedInvocations } }
        set { sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDReceivedInvocationsLock.withLock { sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDUnderlyingReceivedInvocations = newValue } }
    }

    private let sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDReturnValueLock = NSLock()
    private nonisolated(unsafe) var sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDUnderlyingReturnValue: Result<Void, TimelineControllerError>!
    var sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDReturnValue: Result<Void, TimelineControllerError>! {
        get { sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDReturnValueLock.withLock { sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDUnderlyingReturnValue } }
        set { sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDReturnValueLock.withLock { sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDUnderlyingReturnValue = newValue } }
    }
    nonisolated(unsafe) var sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDClosure: (([GalleryItemInfo], String?, IntentionalMentions, String?) async -> Result<Void, TimelineControllerError>)?

    @concurrent func sendGallery(itemInfos: [GalleryItemInfo], caption: String?, intentionalMentions: IntentionalMentions, inReplyToEventID: String?) async -> Result<Void, TimelineControllerError> {
        sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDCallsCountLock.withLock { sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDUnderlyingCallsCount += 1 }
        sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDReceivedArguments = (itemInfos: itemInfos, caption: caption, intentionalMentions: intentionalMentions, inReplyToEventID: inReplyToEventID)
        sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDReceivedInvocationsLock.withLock { sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDUnderlyingReceivedInvocations.append((itemInfos: itemInfos, caption: caption, intentionalMentions: intentionalMentions, inReplyToEventID: inReplyToEventID)) }
        if let sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDClosure = sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDClosure {
            return await sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDClosure(itemInfos, caption, intentionalMentions, inReplyToEventID)
        } else {
            return sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDReturnValue
        }
    }
    //MARK: - createPoll
...
nonisolated class TimelineProxyMock: TimelineProxyProtocol, @unchecked Sendable {
    ...
    private let sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleReturnValueLock = NSLock()
    private nonisolated(unsafe) var sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleUnderlyingReturnValue: Result<Void, TimelineProxyError>!
    var sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleReturnValue: Result<Void, TimelineProxyError>! {
        get { sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleReturnValueLock.withLock { sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleUnderlyingReturnValue } }
        set { sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleReturnValueLock.withLock { sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleUnderlyingReturnValue = newValue } }
    }
    nonisolated(unsafe) var sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleClosure: ((URL, AudioInfo, String?, IntentionalMentions, @MainActor (SendAttachmentJoinHandleProtocol) -> Void) async -> Result<Void, TimelineProxyError>)?

    @concurrent func sendAudio(url: URL, audioInfo: AudioInfo, caption: String?, intentionalMentions: IntentionalMentions, requestHandle: @MainActor (SendAttachmentJoinHandleProtocol) -> Void) async -> Result<Void, TimelineProxyError> {
        sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleCallsCountLock.withLock { sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleUnderlyingCallsCount += 1 }
        if let sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleClosure = sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleClosure {
            return await sendAudioUrlAudioInfoCaptionIntentionalMentionsRequestHandleClosure(url, audioInfo, caption, intentionalMentions, requestHandle)
        } else {
    ...
    private let sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleReturnValueLock = NSLock()
    private nonisolated(unsafe) var sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleUnderlyingReturnValue: Result<Void, TimelineProxyError>!
    var sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleReturnValue: Result<Void, TimelineProxyError>! {
        get { sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleReturnValueLock.withLock { sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleUnderlyingReturnValue } }
        set { sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleReturnValueLock.withLock { sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleUnderlyingReturnValue = newValue } }
    }
    nonisolated(unsafe) var sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleClosure: ((URL, FileInfo, String?, IntentionalMentions, @MainActor (SendAttachmentJoinHandleProtocol) -> Void) async -> Result<Void, TimelineProxyError>)?

    @concurrent func sendFile(url: URL, fileInfo: FileInfo, caption: String?, intentionalMentions: IntentionalMentions, requestHandle: @MainActor (SendAttachmentJoinHandleProtocol) -> Void) async -> Result<Void, TimelineProxyError> {
        sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleCallsCountLock.withLock { sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleUnderlyingCallsCount += 1 }
        if let sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleClosure = sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleClosure {
            return await sendFileUrlFileInfoCaptionIntentionalMentionsRequestHandleClosure(url, fileInfo, caption, intentionalMentions, requestHandle)
        } else {
    ...
    private let sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleReturnValueLock = NSLock()
    private nonisolated(unsafe) var sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleUnderlyingReturnValue: Result<Void, TimelineProxyError>!
    var sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleReturnValue: Result<Void, TimelineProxyError>! {
        get { sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleReturnValueLock.withLock { sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleUnderlyingReturnValue } }
        set { sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleReturnValueLock.withLock { sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleUnderlyingReturnValue = newValue } }
    }
    nonisolated(unsafe) var sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleClosure: ((URL, URL, ImageInfo, String?, IntentionalMentions, @MainActor (SendAttachmentJoinHandleProtocol) -> Void) async -> Result<Void, TimelineProxyError>)?

    @concurrent func sendImage(url: URL, thumbnailURL: URL, imageInfo: ImageInfo, caption: String?, intentionalMentions: IntentionalMentions, requestHandle: @MainActor (SendAttachmentJoinHandleProtocol) -> Void) async -> Result<Void, TimelineProxyError> {
        sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleCallsCountLock.withLock { sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleUnderlyingCallsCount += 1 }
        if let sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleClosure = sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleClosure {
            return await sendImageUrlThumbnailURLImageInfoCaptionIntentionalMentionsRequestHandleClosure(url, thumbnailURL, imageInfo, caption, intentionalMentions, requestHandle)
        } else {
    ...
    private let sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleReturnValueLock = NSLock()
    private nonisolated(unsafe) var sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleUnderlyingReturnValue: Result<Void, TimelineProxyError>!
    var sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleReturnValue: Result<Void, TimelineProxyError>! {
        get { sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleReturnValueLock.withLock { sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleUnderlyingReturnValue } }
        set { sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleReturnValueLock.withLock { sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleUnderlyingReturnValue = newValue } }
    }
    nonisolated(unsafe) var sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleClosure: ((URL, URL, VideoInfo, String?, IntentionalMentions, @MainActor (SendAttachmentJoinHandleProtocol) -> Void) async -> Result<Void, TimelineProxyError>)?

    @concurrent func sendVideo(url: URL, thumbnailURL: URL, videoInfo: VideoInfo, caption: String?, intentionalMentions: IntentionalMentions, requestHandle: @MainActor (SendAttachmentJoinHandleProtocol) -> Void) async -> Result<Void, TimelineProxyError> {
        sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleCallsCountLock.withLock { sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleUnderlyingCallsCount += 1 }
        if let sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleClosure = sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleClosure {
            return await sendVideoUrlThumbnailURLVideoInfoCaptionIntentionalMentionsRequestHandleClosure(url, thumbnailURL, videoInfo, caption, intentionalMentions, requestHandle)
        } else {
    ...
    private let sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDReturnValueLock = NSLock()
    private nonisolated(unsafe) var sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDUnderlyingReturnValue: Result<Void, TimelineProxyError>!
    var sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDReturnValue: Result<Void, TimelineProxyError>! {
        get { sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDReturnValueLock.withLock { sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDUnderlyingReturnValue } }
        set { sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDReturnValueLock.withLock { sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDUnderlyingReturnValue = newValue } }
    }
    nonisolated(unsafe) var sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDClosure: (([GalleryItemInfo], String?, IntentionalMentions, String?) async -> Result<Void, TimelineProxyError>)?

    @concurrent func sendGallery(itemInfos: [GalleryItemInfo], caption: String?, intentionalMentions: IntentionalMentions, inReplyToEventID: String?) async -> Result<Void, TimelineProxyError> {
        sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDCallsCountLock.withLock { sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDUnderlyingCallsCount += 1 }
        sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDReceivedArguments = (itemInfos: itemInfos, caption: caption, intentionalMentions: intentionalMentions, inReplyToEventID: inReplyToEventID)
        sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDReceivedInvocationsLock.withLock { sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDUnderlyingReceivedInvocations.append((itemInfos: itemInfos, caption: caption, intentionalMentions: intentionalMentions, inReplyToEventID: inReplyToEventID)) }
        if let sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDClosure = sendGalleryItemInfosCaptionIntentionalMentionsInReplyToEventIDClosure {

...
public struct SendButton: View {
    ...
    /// An optional background override for branded composer integrations.
    ///
    /// The default keeps the Compound semantic accent color for existing callers.
    ...
    private var backgroundColor: Color {
        ...
        return backgroundColorOverride ?? .compound.bgAccentRest
    }
    
    /// Creates a send button that performs the provided action.
    public init(mode: Mode = .send,
